  ...
  return (
    <div className="flex gap-2 group">
      <input
        ...
        className="flex-1  border border-white/[0.15] rounded-md px-3.5 py-2.5 text-sm text-slate-200 outline-none focus:border-indigo-500/40 transition-colors placeholder:text-white/35"
      />
      <button
        onClick={submit}
