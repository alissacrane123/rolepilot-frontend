...
export default function ProfileHero({ user }: { user: User | null }) {
  ...
  if (!user) return null;
  return (
    <div className="flex flex-col items-center p-6 pb-5 rounded-xl border border-[#1e1e2e] bg-[#0a0a0f]">
      ...
      <p className="text-sm font-semibold text-slate-100 tracking-tight text-center">
